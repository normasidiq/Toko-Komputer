...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 14, 2025 at 02:35 PM
...
(5, 'Robot M206', 'Mouse', 50000, 3),
(6, 'Keychron K3 Version 3', 'Keyboard', 2150000, 4),
(7, 'HyperX Cloud III', 'Headset', 2251000, 3);
...
ALTER TABLE `detail_transaksi`
  ...
  ADD CONSTRAINT `produk` FOREIGN KEY (`produk_id`) REFERENCES `produk` (`id`) ON DELETE CASCADE;
